...
//        let channel = await client.channel(cname)
        do {
//            await channel.subscribe()
            
//            print("waiting subscribe success")
//            if await channel.status == .subscribed {
//                print("status: \(await channel.status), send new-message to channel")
...
//            print("image...",publicURL.absoluteString)
